                        ...
                        GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_TRANSITION_TYPE:
      /* always returns GTK_STACK_TRANSITION_TYPE_NONE */
...
gtk_stack_realize (GtkWidget *widget)
{
  ...
  GtkStackPrivate *priv = gtk_stack_get_instance_private (stack);
  GdkWindowAttr attributes = (GdkWindowAttr){0};
...
#else
  /* real last prop */
  g_object_class_install_properties (object_class, PROP_TRANSITION_DURATION, stack_props);
#endif
