...
#include <gdk/gdk.h> /* GDK_TYPE_RECTANGLE */
...
#if 0 /* TODO: remove when gtkmenusectionbox is implemented */
...
#if 0 /* TODO: remove when gtkgesture is implemented */
...
#if 0 /* TODO: remove when gdkframeclock is implemented */
