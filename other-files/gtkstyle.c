/* gtkstyle.c from gtk3 right after they moved from GdkWindow to cairo_t,
   but before they changed the api of GtkStyle

   https://gitlab.gnome.org/GNOME/gtk/-/commit/be1d190b2e42a4ca33cab865a3d196daf4c839da
*/
