...
#ifndef __INTERNAL_GTK_SETTINGS_PRIVATE_H__
#define __INTERNAL_GTK_SETTINGS_PRIVATE_H__
...
const gchar *gtk_settings_get_font_name      (GtkSettings *settings);
...
#endif /* __INTERNAL_GTK_SETTINGS_PRIVATE_H__ */
